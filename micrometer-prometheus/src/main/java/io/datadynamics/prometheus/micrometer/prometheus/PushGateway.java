package io.datadynamics.prometheus.micrometer.prometheus;
 ...
 * }</pre>
 *
 * <p>See <a href="https://github.com/prometheus/pushgateway">https://github.com/prometheus/pushgateway</a>.
 */
public class PushGateway {
    ...
    /**
     * The {@link PrometheusProperties} will be used to override what is set in the {@link PushGateway.Builder}.
     */
    public static PushGateway.Builder builder(PrometheusProperties config) {
        return new PushGateway.Builder(config);
    }
    ...
    public static class Builder {
         ...
         */
        public PushGateway.Builder registry(PrometheusRegistry registry) {
            if (registry == null) {
                throw new NullPointerException();
            }
            this.registry = registry;
        ...
        public PushGateway build() {
            ...
            try {
                return new PushGateway(registry, getFormat(), makeUrl(properties), connectionFactory, requestHeaders);
